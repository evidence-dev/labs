<script>
	import echartsCustomMap from './echartsCustomMap.js';
	import echartsCanvasDownload from '@evidence-dev/component-utilities/echartsCanvasDownload';
	import { EchartsCopyTarget, DownloadData } from '@evidence-dev/core-components';
...
>
	{#if !printing}
        ...
        "
			use:echartsCustomMap={{ config, hasLink, mapJson, mapName }}
		/>
	{/if}
